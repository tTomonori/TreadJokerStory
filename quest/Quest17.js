class Quest17 extends Quest{
	...
	setChara(){
		...
		this.addChara({chara:{charaCategory:"hero",num:9},team:"F",position:{x:6,y:1},operationNum:1,status:[]})
		this.addChara({chara:{charaCategory:"hero",num:14},team:"F",position:{x:6,y:5},operationNum:1,status:[]})
	}
